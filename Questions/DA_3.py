class Agent:
    ...
    def TakeAction(self,action):
        ...
        if self._isAlive == False:
            print('\nAction cannot be performed. Agent is DEAD. Location:{0}'.format(self._curLoc))
            return False
        
        if self._hasExited == True:
            print('\nAction cannot be performed. Agent has exited the Wumpus world.'.format(self._curLoc))
            return False
        ...
        self._curLoc = newLoc
        print('\nAction Taken: {0}, Current Location {1}'.format(action,self._curLoc))
    ...
    def PerceiveCurrentLocation(self):
        ...
        if self._isAlive == False:
            print('\nAgent cannot perceive. Agent is DEAD. Location:{0}'.format(self._curLoc))
            return [None,None]
        
        if self._hasExited == True:
            print('\nAgent cannot perceive. Agent has exited the Wumpus World.'.format(self._curLoc))
            return [None,None]
